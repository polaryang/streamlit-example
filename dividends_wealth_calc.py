...
with st.form("request_form"):
   ...
   if submitted:
      #try:
        ...
        #file_out='ttt.xlsx'
        file_out=r'https:\github.com\polaryang\streamlit-example\raw\master\EFT_Dividend.xlsx'
        ...
        send_email('polaryang@gmail.com', 'ryxbncdvmgncqepk', email_receiver, 'smtp.gmail.com', 587, email_message, '財富自由客戶需求', attachment=os.path.basename(file_out))
