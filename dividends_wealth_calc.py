...
email_message=email_message+str(income_bonus)+'/n每月生活開銷:'+str(expense)+'/n年通貨膨脹率:'+str(inflation)+'/n投資佔可支配所得率:'+str(idir)+'/n可動用存股:'+strredempt)+'/n投資標的:'+ID_name+':'+stock_ticker
